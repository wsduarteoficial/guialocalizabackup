...
var CheckEmailClientRegistered = function () {
	function CheckEmailClientRegistered() {
		_classCallCheck(this, CheckEmailClientRegistered);
	}

	_createClass(CheckEmailClientRegistered, null, [{
		key: 'ckeck',
		value: function ckeck() {
			...
			$(document).on('blur', 'input[name="email_primary"]', function () {
				...
				// if (number.length >= 10) {
				//     CheckEmailClientRegistered._check(number, element);
				// }
			});
		}
	}, {
				...
				Object.keys(obj).forEach(function (key) {
					...
					Object.keys(value).forEach(function (key) {
						...
						if (v.name_fantasy !== 'undefined' && v.name_fantasy) {
							CheckEmailClientRegistered.boxSwal(element, v.name_fantasy, number, v.pivot.company_id);
						}
					});
				});
			});
	...
	return CheckEmailClientRegistered;
}();
//# sourceMappingURL=CheckEmailClientRegistered.js.map