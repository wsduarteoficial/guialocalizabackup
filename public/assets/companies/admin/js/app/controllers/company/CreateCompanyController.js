...
var CreateCompanyController = function (_BaseCompanyControlle) {
	_inherits(CreateCompanyController, _BaseCompanyControlle);
	...
	_createClass(CreateCompanyController, [{
		...
		value: function focusZipcode() {
			_get(CreateCompanyController.prototype.__proto__ || Object.getPrototypeOf(CreateCompanyController.prototype), 'focusZipcode', this).call(this);
		}
	}, {
		key: 'openModalRegister',
		value: function openModalRegister() {
			_get(CreateCompanyController.prototype.__proto__ || Object.getPrototypeOf(CreateCompanyController.prototype), 'openModalRegister', this).call(this, '#modal-register-district');
			_get(CreateCompanyController.prototype.__proto__ || Object.getPrototypeOf(CreateCompanyController.prototype), 'openModalRegister', this).call(this, '#modal-register-place');
		}
	}, {
		key: 'submitModal',
		value: function submitModal() {
			_get(CreateCompanyController.prototype.__proto__ || Object.getPrototypeOf(CreateCompanyController.prototype), 'submitModal', this).call(this, 'form[name=create-register-district]');
			_get(CreateCompanyController.prototype.__proto__ || Object.getPrototypeOf(CreateCompanyController.prototype), 'submitModal', this).call(this, 'form[name=create-register-place]');
		}
	}, {
		key: '_typeRedirect',
		...
		key: '_checkNumberPhoneIsEmpty',
		value: function _checkNumberPhoneIsEmpty() {

			var fixed = $('#jq_phone_fixed').val();
			var cell = $('#jq_phone_cell').val();
			var others = $('#jq_phone_others').val();

			if (!fixed && !cell && !others) {
		...
		value: function _checkFillDistrictIsSuggest() {
			return _get(CreateCompanyController.prototype.__proto__ || Object.getPrototypeOf(CreateCompanyController.prototype), 'checkFillDistrictIsSuggest', this).call(this);
		}
	}, {
		key: '_checkFillPlaceIsSuggest',
		value: function _checkFillPlaceIsSuggest() {
			return _get(CreateCompanyController.prototype.__proto__ || Object.getPrototypeOf(CreateCompanyController.prototype), 'checkFillPlaceIsSuggest', this).call(this);
		}
	}, {
		key: '_controlClassHidePlan',
		value: function _controlClassHidePlan() {
		...
		value: function _sendForm() {
			...
			$('form[name="create-new-company"]').on('submit', function (e) {
				...
				var valid = this._checkNumberPhoneIsEmpty();
				if (!valid) {
					e.preventDefault();
...
//# sourceMappingURL=CreateCompanyController.js.map