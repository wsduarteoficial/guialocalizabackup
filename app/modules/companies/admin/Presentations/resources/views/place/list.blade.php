...
@section('breadcrumb')
   <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span>Visualizando Logradouros</span>
        </li>
    </ul>   
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    ...
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject"> Listando logradouros em <span class="bold uppercase">{{ $city->name ."-". $city->state->abbr }}</span></span>
                    </div>
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column hide" id="sample_1">
                        ...
                        <tbody class="appendedContainer">
                            ...
                            <tr class="odd gradeX {!! $place->active === '1' ? 'color_status' : '' !!}">
                                <td>
                                    {{ $place->id }}
                                </td>
                                <td><span class="jq_place_name_{{ $place->id }}">{{ $place->name }}</span></td>
                                <td>
                                    {{ $city->name ."-". $city->state->abbr }}
                                </td>
                
                                <td class="center">  
                                    <input type="checkbox" class="jq_status_place" {!! $place->active === '1' ? 'checked' : '' !!} value="{{ $place->active }}" data-id="{{ $place->id }}"  data-name="{{ $place->name }}" data-toggle="toggle" data-onstyle="success"> 
                                </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li>                   
                                                <a href="#" data-id="{{ $place->id }}" data-name="{{ $place->name }}" onclick="ListPlaceController.setDataModalEdit(this.getAttribute('data-id'), this.getAttribute('data-name') );"  data-target=".modal-edit" data-toggle="modal">
                                                    <i class="fa fa-edit"></i> Editar 
                                                </a>
                                            </li>       

                                            <li>
                                                <a href="#" class="jq_remove_place"  data-id="{{ $place->id }}" data-name="{{ $place->name }}" >
        ...
        <div class="modal-content">
            ...
            <form id="register" action="">                
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title bold">Cadastrar Logradouro</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">                    
                            <input required="required" oninvalid="this.setCustomValidity('Informe o nome do Logradouro.')" type="text" class="col-md-12 form-control" placeholder="Nome do Logradouro" name="name"> 
                            <br>
                            <br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="edit" action="">                
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title bold">Editar Logradouro</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">                    
                            <input required="required" oninvalid="this.setCustomValidity('Informe o nome do Logradouro.')" type="text" class="col-md-12 form-control" placeholder="Nome do Logradouro" id="edit-place-name" name="name" value=""> 
                            <br>
                            <br>
                            <h4>Cidade: <span class="bold"> {{ $city->name ."-". $city->state->abbr }} </span> </h4>
                            <input type="hidden" id="edit-city-id" name="city_id" value="{{ $city->id }}">                      
                            <input type="hidden" id="edit-place-id" name="place_id" value="">                      
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<script src="{{ asset('/assets/companies/admin/js/app/services/ListPlaceService.js') }}" type="text/javascript"></script>
<script src="{{ asset('/assets/companies/admin/js/app/controllers/ListPlaceController.js') }}" type="text/javascript"></script>

<script>
(function() {
    'use strict'; 
    var controllerListPlace = new ListPlaceController();
    controllerListPlace.init();
})();
</script>
@endsection
