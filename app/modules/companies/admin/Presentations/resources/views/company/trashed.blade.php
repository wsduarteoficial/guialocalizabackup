                                ...
                                @if(isset( $companies ) )
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-xs green jq_force_restore_company" data-id="{{ $company->id }}" data-name="{{ $company->name_fantasy }}">
                                                <i class="fa fa-history"></i> Restaurar
                                            </a>

                                            <a class="btn btn-xs red jq_force_remove_company" data-id="{{ $company->id }}" data-name="{{ $company->name_fantasy }}">
                                                Remover Permanentemente <i class="fa fa-times"></i>
                                            </a>
