...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li>
    <span>Relatório de Cliques de Visualização de Telefones</span>
  </li>
</ul>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"> Relatório de Cliques de Visualização de Telefones </div>
        <div class="panel-body">

          <div class="portlet-body form">
            <form class="form-horizontal" role="form" action="{{ route('admin.reports.company.clicks.view') }}" target="_blank">
              <div class="form-body">
