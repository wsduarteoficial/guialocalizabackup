  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"> Relatório de Vencimentos </div>
        <div class="panel-body">

          <div class="portlet-body form">
            <form class="form-horizontal" role="form" action="{{ route('admin.reports.company.payments.view') }}" target="_blank">
              <div class="form-body">
                ...
                <div class="form-group jq_elem_hide">
...
$(document).on('click', 'input[name="date_start"], input[name="date_end"]', function() {
  $('.jq_elem_hide').show(500);
  $('.jq_combo_plan').find('option[value=1]').hide();
});
