...
<head>
  <meta charset="utf-8">
  <title>Relatório de Cadastros {{ $active == '1' ? 'Ativos' : 'Inativos' }} #P-{{ Request::get('page') ? Request::get('page') : 1 }} {{ date('d-m-Y_H:i:s') }}</title>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">
              Relatório de Cadastros {{ $active == '1' ? 'Ativos' : 'Inativos' }} - {{ $plan->name }}
            </h3>
          </div>
