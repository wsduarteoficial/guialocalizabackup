  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"> Relatório de Empresas </div>
        <div class="panel-body">

          <div class="portlet-body form">
            <form class="form-horizontal" role="form" action="{{ route('admin.reports.company.registers.view') }}" target="_blank">
              <div class="form-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="mt-radio-list">
                      <label class="mt-radio"> Relatório em ordem alfabética por nome
                        <input type="radio" value="name" name="order" checked />
                        <span></span>
                      </label>
                      <label class="mt-radio"> Relatório em ordem alfabética por telefone
                        <input type="radio" value="phone" name="order" />
                        <span></span>
                      </label>
