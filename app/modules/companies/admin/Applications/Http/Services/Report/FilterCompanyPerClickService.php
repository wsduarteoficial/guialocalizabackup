...
class FilterCompanyPerClickService
{
    ...
    /**
     * FilterCompanyPerClickService constructor.
    ...
    public function make(Request $request)
    {
        ...
        return $this->repository->listOrderByNameAscAndCountClick($data);
