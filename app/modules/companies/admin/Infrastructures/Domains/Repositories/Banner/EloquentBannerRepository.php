...
namespace GuiaLocaliza\Companies\Admin\Infrastructures\Domains\Repositories\Banner;
 ...
 * @package GuiaLocaliza\Companies\Admin\Infrastructures\Domains\Repositories\Banner
...
class EloquentBannerRepository extends BaseEloquentAbstractRepository implements BannerRepository
{
    ...
    private function filterBanners(array $data)
    {
        ...
        if(count($data['categories_ids'])<=0){
            return false;
        }
