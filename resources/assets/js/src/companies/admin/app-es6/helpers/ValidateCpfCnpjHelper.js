(function(){
    ...
    {
        let cpf_cnpj = $('.cpf_cnpj').val().replace(/[^0-9]/g, '').toString();
        ...
        if( cpf_cnpj.length == 11 )
        {
            ...
            {
                swal ( "Atenção!" ,  `O número ${cpf_cnpj} é um CPF inválido!`,  "error" );
                $('.cpf_cnpj').val('');
                $('.cpf_cnpj').focus();
        ...
        {     
            ...
            if (resultado != digitos.charAt(1)) {
                ...
                swal ( "Atenção!" ,  `O número ${cpf_cnpj} é um CNPJ inválido!`,  "error" );
                $('.cpf_cnpj').val('');
                $('.cpf_cnpj').focus();          
            ...
            swal ( "Atenção!" ,  `Por favor, informe um CPF ou CNPJ válido!`,  "error" );
            $('.cpf_cnpj').val('');
            $('.cpf_cnpj').focus();
            $(".cpf_cnpj").unmask();  
        }
